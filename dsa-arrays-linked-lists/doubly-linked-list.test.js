...
describe("pop", function() {
  it("removes node at end and increments length", function() {
...
describe("shift", function() {
  it("removes node at start and increments length", function() {
    let lst = new DoublyLinkedList([5, 10, 15]);
    ...
    expect(lst.tail.val).toBe(15);
    expect(lst.tail.prev.val).toBe(null);
    expect(lst.length).toBe(1);
...
describe("setAt", function() {
  it("sets val at index", function() {
    ...
    expect(lst.tail.prev.val).toBe(1);
  });
});
...
describe("removeAt", function() {
  it("removes from 1-item list", function() {
    ...
    lst.removeAt(0);
    expect(lst.length).toBe(1);
    expect(lst.head).toBe("b");
    expect(lst.head.prev).toBe(null);
    expect(lst.tail).toBe("b");
